...
public class FeetInchComparsionTest {
    @Test
    ...
    @Test
    void givenFeetAndFeetFromDiffReference_WhenNotEqual_ShouldReturnFalse() {
        Feet feet1 = new Feet(0.0);
        Feet feet2 = new Feet(0.0);
    ...
    @Test
    void givenInchAndInchFromSameReference_WhenEqual_ShouldReturnTrue() {
        Inch inch1 = new Inch(0.0);
        boolean actual = inch1 == inch1;
    }
    @Test
    void givenInchAndInchFromDiffReference_WhenNotEqual_ShouldReturnFalse() {
        Inch inch1 = new Inch(0.0);
